...
main:                                   // @main
.Lfunc_begin0:
	.file	1 "/home/ubuntu/workspace/kernel/out/../arch/arm64/kernel/asm-offsets.c"
...
.ascii "->TSK_ACTIVE_MM 1344 offsetof(struct task_struct, active_mm)"
	//NO_APP
...
.ascii "->VCPU_WORKAROUND_FLAGS 2056 offsetof(struct kvm_vcpu, arch.workaround_flags)"
	//NO_APP
...
.ascii "->VCPU_FPEXC32_EL2 1992 offsetof(struct kvm_vcpu, arch.ctxt.sys_regs[FPEXC32_EL2])"
	//NO_APP
	.loc	1 144 3                         // ../arch/arm64/kernel/asm-offsets.c:144:3
	//APP
	
.ascii "->VCPU_HOST_CONTEXT 3104 offsetof(struct kvm_vcpu, arch.host_cpu_context)"
	//NO_APP
...
.Linfo_string1:
	.asciz	"../arch/arm64/kernel/asm-offsets.c" // string offset=38
.Linfo_string2:
	.asciz	"/home/ubuntu/workspace/kernel/out" // string offset=73
.Linfo_string3:
